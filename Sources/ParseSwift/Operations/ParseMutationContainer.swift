...
/**
 A `ParseMutation` represents a modification to a value in a `ParseObject`.
 For example, setting, deleting, or incrementing a value are all `ParseMutation`'s.
 `ParseMutation` themselves can be considered to be immutable.
 */
public final class ParseMutation<T>: ParseType where T: ParseObject {
